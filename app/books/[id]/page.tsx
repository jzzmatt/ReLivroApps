...
export async function generateMetadata({
  ...
  const {data} = await supabase
    .from("books")
    .select("title,description,subject,city,grade")
    .eq("id", id)
    .maybeSingle();
        ...
        <div className="detail-grid">
          ...
          <div className="detail-copy">
            <div className="detail-topline">
              <span className={"mode " + book.mode.toLowerCase()}>{book.mode}</span>
            ...
            <div className="seller-mini">
              <div className="seller-avatar">
                {book.profiles?.avatar_url ? (
                  ...
                  (book.profiles?.display_name || "RL").slice(0, 2).toUpperCase()
                )}
              </div>
              <div>
                <small>Vendedor</small>
                <strong>{book.profiles?.display_name || "Membro ReLivroApps"}</strong>
            ...
            <div className="detail-actions">
              {own ? (
                ...
                <ContactSellerButton bookId={book.id} />
              )}
