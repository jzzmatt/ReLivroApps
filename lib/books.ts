...
export type Book={id:string;seller_id:string;title:string;subject:string;grade:string;condition:BookCondition;mode:ListingMode;price_kz:number;description:string|null;city:string|null;municipality:string|null;is_published:boolean;status:"active"|"reserved"|"sold"|"exchanged";sold_at:string|null;created_at:string;updated_at:string;book_images?:BookImage[];profiles?:{display_name:string|null;avatar_url:string|null}|null};
